		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"100%","margin":"0 0 20px","flexWrap":"wrap","display":"flex"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"width":"100%","padding":"0","margin":"20px 0 20px","background":"none","display":"flex"}'>
					...
					<el-button :style='{"border":"1px dotted #2adbcb","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#2ce1d2","borderRadius":"0px","background":"#edfbfa","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('xuesheng','男女比例')" type="warning" @click="chartDialog1()">男女比例</el-button>
				</el-row>
			</el-form>
