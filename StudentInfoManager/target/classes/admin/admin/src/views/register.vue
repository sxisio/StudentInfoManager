	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20221201/ad8b598515704341aed4de6f4d3b36b8.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"minHeight":"750px","padding":"30px 0px 60px 600px","margin":"0px auto 0 auto","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20221130/96464fa9ee1447fcac8ed4cef9e06ae1.png) no-repeat right top","width":"1200px","backgroundSize":"auto 100%","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"width":"550px","margin":"0 0px 16px -34px","lineHeight":"40px","fontSize":"20px","color":"#160f53","textAlign":"center"}' class="title">基于SpringBoot的学生综合信息管理系统注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">教师账号</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">导员账号</div>
					<el-input  v-model="ruleForm.daoyuanzhanghao"  autocomplete="off" placeholder="导员账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">密码</div>
					<el-input  v-model="ruleForm.mima"  autocomplete="off" placeholder="密码"  type="password"  />
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">导员姓名</div>
					<el-input  v-model="ruleForm.daoyuanxingming"  autocomplete="off" placeholder="导员姓名"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">年龄</div>
					<el-input  v-model="ruleForm.nianling"  autocomplete="off" placeholder="年龄"  type="text"  />
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
                    ...
                    <el-select v-model="ruleForm.xingbie" placeholder="请选择性别" >
                        <el-option
                            v-for="(item,index) in daoyuanxingbieOptions"
                            v-bind:key="index"
                            :label="item"
                            :value="item">
                        </el-option>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
                    ...
                    <el-select v-model="ruleForm.xueyuan" placeholder="请选择学院" >
                        <el-option
                            v-for="(item,index) in daoyuanxueyuanOptions"
                            v-bind:key="index"
                            :label="item"
                            :value="item">
                        </el-option>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='daoyuan'">
                    ...
                    <file-upload
                        ...
                        :multiple="true"
                        :fileUrls="ruleForm.touxiang?ruleForm.touxiang:''"
                        @change="daoyuantouxiangUploadChange"
                    ></file-upload>
				</el-form-item>
...
export default {
	data() {
		return {
            ...
            xueshengdaoyuanzhanghaoOptions: [],
            xueshengjiaoshizhanghaoOptions: [],
            jiaoshixingbieOptions: [],
            jiaoshixueyuanOptions: [],
            daoyuanxingbieOptions: [],
            daoyuanxueyuanOptions: [],
		};
	},
	mounted(){
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                this.xueshengdaoyuanzhanghaoOptions = data.data;
            } else {
                this.$message.error(data.msg);
            }
        });
        ...
        this.daoyuanxingbieOptions = "男,女".split(',')
        this.$http({
            url: `option/xueyuanxinxi/xueyuan`,
            method: "get"
        }).then(({ data }) => {
            if (data && data.code === 0) {
                this.daoyuanxueyuanOptions = data.data;
            } else {
                this.$message.error(data.msg);
            }
        });
	...
	methods: {
        ...
        daoyuantouxiangUploadChange(fileUrls) {
            this.ruleForm.touxiang = fileUrls;
        },
		...
		login() {
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if((!this.ruleForm.daoyuanzhanghao) && `daoyuan` == this.tableName){
						this.$message.error(`导员账号不能为空`);
						return
					}
					...
					if((!this.ruleForm.mima) && `daoyuan` == this.tableName){
						this.$message.error(`密码不能为空`);
						return
					}
					...
					if((this.ruleForm.mima!=this.ruleForm.mima2) && `daoyuan` == this.tableName){
						this.$message.error(`两次密码输入不一致`);
						return
					}
					if((!this.ruleForm.daoyuanxingming) && `daoyuan` == this.tableName){
						this.$message.error(`导员姓名不能为空`);
						return
					}
					...
					if(`daoyuan` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
						this.$message.error(`年龄应输入整数`);
						return
					}
					...
					if(`daoyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
						this.$message.error(`手机应输入手机格式`);
						return
					}
