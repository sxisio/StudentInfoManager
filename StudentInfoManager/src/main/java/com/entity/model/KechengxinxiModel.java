...
public class KechengxinxiModel  implements Serializable {
	...
	public void setJiaoshididian(String jiaoshididian) {
		this.jiaoshididian = jiaoshididian;
	}
	
	/**
	 * 获取：教室地点
	 */
	public String getJiaoshididian() {
		return jiaoshididian;
	}
