...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpSession httpSession) {
        ...
        httpSession.setAttribute("user",u.getJiaoshixingming());
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengEntity xuesheng,
		...
		if(tableName.equals("daoyuan")) {
			xuesheng.setDaoyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("daoyuan")) {
            ew.eq("daoyuanzhanghao", (String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
