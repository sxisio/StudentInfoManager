...
public class DaibantixingController {
    ...
    public R page(@RequestParam Map<String, Object> params,DaibantixingEntity daibantixing,
		...
		if(tableName.equals("daoyuan")) {
			daibantixing.setDaoyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R query(DaibantixingEntity daibantixing){
		...
		return R.ok("查询代办提醒成功").put("data", daibantixingView);
    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		daibantixing.setClicknum(daibantixing.getClicknum()+1);
		daibantixing.setClicktime(new Date());
		daibantixingService.updateById(daibantixing);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("daoyuan")) {
			wrapper.eq("daoyuanzhanghao", (String)request.getSession().getAttribute("username"));
		}
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DaibantixingEntity daibantixing, HttpServletRequest request,String pre){
        EntityWrapper<DaibantixingEntity> ew = new EntityWrapper<DaibantixingEntity>();
